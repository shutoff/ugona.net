...
public class DeviceSettingsFragment extends DeviceFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        items.add(new SeekBarPrefItem(R.string.temp_correct, Names.TEMP_SIFT, -10, 10, "\u00B0C", 1));
        items.add(new SeekBarPrefItem(R.string.voltage_shift, Names.VOLTAGE_SHIFT, -20, 20, "V", 0.05));
