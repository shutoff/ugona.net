...
public class CalendarDatePickerDialog extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView tvDone = (TextView) view.findViewById(R.id.done);
        tvDone.setText(tvDone.getText().toString().toUpperCase());
        ...
        tvCancel.setText(tvCancel.getText().toString().toUpperCase());
